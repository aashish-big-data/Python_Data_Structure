...
def createmirroroftree(root):
        if(root != None):
                createmirroroftree(root.l)
                createmirroroftree(root.r)
...
def check2treesformirrorimages(root1, root2):
        ...
        if(root1.v != root2.v):
                ...
                return check2treesformirrorimages(root1.l, root2.r) and check2treesformirrorimages(root1.r, root2.l)
...
tree1.printFullTree()
print "Check if two trees are mirror images of each other:"
print (check2treesformirrorimages(tree.root,tree1.root))
